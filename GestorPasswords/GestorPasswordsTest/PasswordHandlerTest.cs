...
namespace DataManagerTest
{
    ...
    public class PasswordHandlerTest
    {
        ...
        [TestMethod]
        public void GeneratePasswordWithLengthBetween15And25AndOnlyDigitsAndSymbols()
        {
            PasswordGenerationConditions conditions = new PasswordGenerationConditions()
            {
                Length = 23,
        ...
        [TestMethod]
        public void GeneratePasswordWithLengthBetween15And25AndOnlyLowersUppersAndDigits()
        {
            PasswordGenerationConditions conditions = new PasswordGenerationConditions()
            {
                Length = 24,
        ...
        [TestMethod]
        public void GeneratePasswordWithLengthBetween15And25AndOnlyLowersDigitsAndSymbols()
        {
            PasswordGenerationConditions conditions = new PasswordGenerationConditions()
            {
                Length = 19,
        ...
        [TestMethod]
        public void GeneratePasswordWithLengthBetween15And25AndOnlyUppersDigitsAndSymbols()
        {
            PasswordGenerationConditions conditions = new PasswordGenerationConditions()
            {
                Length = 20,
        ...
        [TestMethod]
        public void GeneratePasswordWithLengthBetween15And25AndLowersUppersDigitsAndSymbols()
        {
            PasswordGenerationConditions conditions = new PasswordGenerationConditions()
            {
                Length = 23,
